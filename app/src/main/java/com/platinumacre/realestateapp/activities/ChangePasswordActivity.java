...
import com.platinumacre.realestateapp.databinding.ActivityChangePasswordBinding;
        ...
        firebaseUser.updatePassword(newPassword)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Log.e(TAG, "onFailure: ", e);
                        progressDialog.dismiss();
                        MyUtils.toast(ChangePasswordActivity.this, "Failed to update password due to "+e.getMessage());
                    }
                });
    }
}